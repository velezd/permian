...
from libpermian.plugins import load
...
class TestSettingsOverridesPlugin(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        os.mkdir('./libpermian/plugins/testplugin')
        with open('./libpermian/plugins/testplugin/__init__.py', 'w') as init_file:
            pass
        with open('./libpermian/plugins/testplugin/settings.ini', 'w') as settings_file:
            settings_file.write('[TestSection]\nsource=plugin')
        load()  # Reload plugins

    @classmethod
    def tearDownClass(cls):
        shutil.rmtree('./libpermian/plugins/testplugin')
...
class TestSettingsDefault(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_parser.read('./libpermian/default.ini')
